...
// Json::Value makeJson(std::vector<std::pair<std::string, std::string>>
// &&fields ) {
//     Json::Value j;
...
//     EXPECT_CALL(
//         *mock_user_repo, getByHandle(param.request_dto.handle)
//     )
...
//         .WillRepeatedly(Invoke(
//             [param](const std::string &, const std::string &, const
//             std::string &)
//                 -> drogon::Task<bool> {
